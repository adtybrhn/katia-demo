...
RequestObject request = findTestObject("Object Repository/reqres/Register User")
...
try {
	...
	KatiaReporter.addTestResult("API-002", "Register User", "PASSED", gabunganData)
} catch (Exception e) {
	KatiaReporter.addTestResult("API-002", "Register User", "FAILED", gabunganData)
}
