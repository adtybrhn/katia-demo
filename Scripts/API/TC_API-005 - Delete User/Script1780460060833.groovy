...
RequestObject request = findTestObject("Object Repository/reqres/Delete User")
...
// 7. Validasi dan Catat (gunakan variabel expectedStatusCode agar konsisten)
try {
	WS.verifyResponseStatusCode(response, 200)
	KatiaReporter.addTestResult("API-005", "Delete User", "PASSED", gabunganData)
} catch (Exception e) {
	KatiaReporter.addTestResult("API-005", "Delete User", "FAILED", gabunganData)
}
