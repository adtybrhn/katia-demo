...
RequestObject request = findTestObject("Object Repository/reqres/Login")
...
try {
	...
	KatiaReporter.addTestResult("API-003", "Login", "PASSED", gabunganData)
} catch (Exception e) {
	KatiaReporter.addTestResult("API-003", "Login", "FAILED", gabunganData)
}
