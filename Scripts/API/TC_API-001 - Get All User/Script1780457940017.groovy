...
RequestObject request = findTestObject("Object Repository/reqres/Get All User")
...
try {
	...
	KatiaReporter.addTestResult("API-001", "Get All User", "PASSED", gabunganData)
} catch (Exception e) {
	KatiaReporter.addTestResult("API-001", "Get All User", "FAILED", gabunganData)
}
